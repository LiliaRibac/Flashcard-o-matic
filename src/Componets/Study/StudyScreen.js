...
//   const clickHandeler = () => {
//     if (curentIndex < study.cards.length - 1) {
...
//             Card : {curentIndex + 1} of {study.cards.length}
//           </h5>
//           <p className='card-text'>
//             {flipped
//               ? study.cards[curentIndex].back
//               : study.cards[curentIndex].front}
//           </p>
//           <button className='btn btn-secondary' onClick={handleFlip}>
//             Flip
//           </button>
//           {flipped && (
//             <button className='btn btn-primary mx-2' onClick={clickHandeler}>
//               Next
//             </button>
//           )}
//         </div>
